  ...
  return (
    <div className="container mx-auto p-4 lg:mt-1 mt-10">
      <div className="flex items-center justify-between mb-4">
        <h1 className="md:text-3xl text-2xl  font-bold">Car Accessories</h1>
        <div className="flex items-center space-x-4">
          ...
          <a className=" text-black  text-sm">Car Accessories</a>
        </div>
      </div>
      <p className="text-gray-600 text-xs md:text-sm mb-4">
        Find the latest car accessories, tools, and gadgets.
      </p>
      <p className="text-gray-600 text-xs md:text-sm mb-4">
        Discover innovative and trendy car products that will make your life
        easier.
      </p>
      ...
      <Kitchen products={products} title={"Car Accessories"} />
    </div>
  );
}
